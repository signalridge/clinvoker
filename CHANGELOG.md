...
* **ci:** ignore CHANGELOG.md in markdownlint ([#47](https://github.com/signalridge/clinvoker/issues/47)) ([39e9dc9](https://github.com/signalridge/clinvoker/commit/39e9dc9b64ea86ddd99caf004c2ec246833623a7))
...
* **release:** reset release-please manifest ([#48](https://github.com/signalridge/clinvoker/issues/48)) ([28ac1eb](https://github.com/signalridge/clinvoker/commit/28ac1ebdcf8ba2a0cd46f694b85c39e3185ed5bb))


### 🔧 Refactoring

* **ci:** consolidate release workflow ([#50](https://github.com/signalridge/clinvoker/issues/50)) ([5048428](https://github.com/signalridge/clinvoker/commit/504842858f93ef2bb5ea255417dae2771618b906))
...
* Auth failure responses now use structured `code`/`message`/`request_id` and no longer include legacy `error` field
