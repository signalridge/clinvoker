...
| [CI/CD](ci-cd.md) | 自动化代码审查、文档 | `/api/v1/*` |
| [客户端库](client-libraries.md) | Python、TypeScript、Go 客户端 | 所有端点 |
...
1. **clinvk 已安装**：见 [安装](../guide/installation.md)
...
- **自动化**：查看 [CI/CD 集成](ci-cd.md)
- **自定义开发**：查阅 [客户端库](client-libraries.md)
