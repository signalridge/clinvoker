---
title: Installation
description: Install clinvoker on your system.
---
...
- [First Prompt](first-prompt.md) - Run your first prompt
- [Configuration](../how-to/configuration.md) - Customize your setup
